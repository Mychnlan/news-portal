        ...
        $('#article-table').DataTable({
            ...
            processing: true,
                ...
                columns: [
                    ...
                    { data: 'author.full_name', name: 'author.full_name', 
                    ...
                    { data: 'status', name: 'status'},
                    {
                        ...
                        render: function (data, type, row) {
                            return '<a href="/admin/article/' + data.id + '/edit" class="tw-bg-blue-500 hover:tw-bg-blue-600 tw-text-white tw-font-bold tw-py-2 tw-px-4 tw-rounded"> <i class="fa-solid fa-pen-to-square"></i></a> ' +
